...
with st.expander("How to Navigate the App:", expanded=True):
    ...
    **Quick Navigation**: Use the dropdown menu labeled "Quick Navigate to" to instantly zoom into specific areas of interest, along with descriptions of the sites in that area. The sliders below will automatically adjust to the selected area.
...
library_text_4 = """**Major Features of Medieval Illuminated Manuscripts:** Illuminated manuscripts are distinguished by their decorative elements which include a variety of features. Below are descriptions of those features, along wtih examples of medieval manuscripts held at the Abbot Vincent Taylor Library at Belmont Abbey."""
library_text_5 = """**Decorated initials:** Decorate initials in medieval manuscripts are enlarged, artistically adorned letters signaling the start of new text sections, serving both as beautiful navigational aids and symbols of sacred significance. An example of this practice can be found in this page from an antiphonal, a large-format liturgical book used by choirs during the Divine Office. This text guided the singing of daily prayers and chants. These manuscripts, often embellished with ornate designs, epitomize the union of art, devotion, and functionality, reflecting the rich cultural and spiritual tapestry of the medieval Christian world. Their grandeur not only enhanced the aesthetic appeal but also indicated the economic and religious status of their possessors."""
library_text_6 = """This breviary from Italy from around 1400 is a liturgical book used as a daily guide for prayer and reflection, helping individuals align themselves with the spiritual rhythms of the church calendar. It contains the texts of the Divine Office, a set of prayers, hymns, psalms, and readings to be recited at specific hours of the day. These daily prayer recitations were integral to monastic life. By following the breviary, individuals could attune their daily lives to the liturgical calendar, marking the feasts, saints' days, and seasons of the church year. This particular image contains the following common elements in a medieval manuscript:\n\n**Ornamental Borders:** Besides their aesthetic appeal, the borders also help frame the text, creating a visual boundary and adding a sense of sanctity and importance to the contents within. The botanical motifs and colors used could have been chosen for their symbolic meanings, representing virtues, biblical stories, or attributes of saints.\n\n**Marginalia:** While primarily decorative, marginalia often have deeper meanings. They might reflect contemporary events, societal norms, or even the whims and thoughts of the scribe or illuminator. They offer a glimpse into the cultural and social milieu of the time.\n\n**Gold Leaf:** The use of gold in manuscripts, especially religious texts, is symbolic of the divine and the heavenly realm. Its luminosity and value added a sense of reverence to the text. In a practical sense, the shimmering quality of gold would have also illuminated the page, especially under candlelight, enhancing the reading experience in dimly lit settings like monastic cells or churches."""
library_text_7 = """Another example from the college's collections is the "Two Leaves from The Interpretation of Hebrew Names," which exemplify the scholarly rigor and artistic flair of these medieval scriptoriums.\n\n**Scholarly Nature of the Content:** The very subject of these leaves – the interpretation of Hebrew names – signifies the intellectual pursuits of the monks. It was crucial for them to understand the original meanings of the Biblical names to provide accurate translations and teachings. This text exemplifies the monastic dedication to bridging the gap between ancient languages and the vernacular, ensuring the Bible's true essence remained intact through translations.\n\n**Gothic Script:** The uniformity of the script is testament to the rigorous training of the scribes. In a scriptorium, precision and consistency were paramount. This ensured not only legibility but also uniformity across copies, essential when multiple scribes might work on a single text.\n\n**Columnar Layout:** This efficient use of space is indicative of the scriptorium's systematic approach. Columns helped in organizing vast amounts of information neatly and allowed for easier reading and referencing.\n\n**Decorated Initials:** As with other medieval manuscripts, these leaves employ decorated initials to mark the beginning of new sections. This serves a dual purpose: guiding the reader and embellishing the page. Their presence underscores the harmonious blend of functionality and artistry in monastic manuscripts.\n\n**Marginal Space:** The generous margins are not just a design choice. They provide space for annotations, reflecting the dynamic nature of monastic scholarship where texts were not just read but actively engaged with.\n\nBy studying this manuscript, students can gain insights into the meticulous processes of medieval scriptoriums. Each manuscript was not just a book but a labor of love and devotion, representing countless hours of focused work. From the careful selection of materials to the exacting standards of writing and illumination, every aspect was designed to honor the sacred nature of the texts and to preserve knowledge for future generations. """
...
for point in annotation_points:
    if point['name'] == selected_area:
        ...
        if selected_area == "The Basilica":
            ...
            content_to_display.append({'type': 'image', 'content': 'app_images/Breviary.jpg'})
            # Text Section 3
            content_to_display.append({'type': 'text', 'content': library_text_6})
            # Image 2
            content_to_display.append({'type': 'image', 'content': 'app_images/two_leaves.jpg'})
            # Text Section 3
